...
Product.create!([
  {name: "Cubs Collar", price: "2", description: "Red, white, and blue Cubs collar, size small.", supplier_id: 1},
  {name: "Star Wars Chewbacca Costume", price: "20", description: "Fuzzy brown chewbacca costume, size large.", supplier_id: 3},
  {name: "Bug costume", price: "12", description: "Bug costume", supplier_id: 1},
  {name: "Christmas Elf Costume", price: "5", description: "cute elf costume.", supplier_id: 1}
])
Supplier.create!([
...
User.create!([
  ...
  {name: "Joy", email: "joe@gmail.com", password_digest: "$2a$10$xwYYx7c5jgPJYSg69VjVyuvwQ6nGHxJ0YdXmbLqgKCnYINePxrDn."},
  {name: "joy", email: "joy@gmail.com", password_digest: "$2a$10$jeyaVdGSmksoHnp/OGuvX./jr5KscFppf39G/KVAI4t07wJnRABbW"},
